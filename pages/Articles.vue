...
export default {
  ...
  head: {
    title: "Recent Articles 📚 - Puneeth Chanda",
    meta: [
      {
        hid: "description",
        name: "description",
        content:
          "Read articles written by Puneeth Chanda, articles include topics under web development (html, css, javascript), mobile app development and many more."
      },
      {
        hid: "og:title",
        name: "og:title",
        content: "Recent Articles 📚 - Puneeth Chanda"
      },
      {
        property: "og:description",
        content: "Read articles written by Puneeth Chanda, articles include topics under web development (html, css, javascript), mobile app development and many more."
      },
    ]
  },
  methods: {
